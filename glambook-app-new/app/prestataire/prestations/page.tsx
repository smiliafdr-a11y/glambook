            ...
            <div className="p-5 space-y-3">
              <div>
                ...
                <input value={form.nom} onChange={e => setForm(f => ({ ...f, nom: e.target.value }))}
                  className="w-full border rounded-lg px-3 py-2 text-sm outline-none focus:border-brand-500" placeholder="ex: Pose gel couleur" />
              </div>
              <div>
              ...
              <div className="grid grid-cols-3 gap-3">
                <div>
                  ...
                  <input type="number" value={form.duree_minutes} onChange={e => setForm(f => ({ ...f, duree_minutes: Number(e.target.value) }))}
                    className="w-full border rounded-lg px-3 py-2 text-sm outline-none focus:border-brand-500" min={15} step={15} />
                </div>
                <div>
                  ...
                  <input type="number" value={form.prix} onChange={e => setForm(f => ({ ...f, prix: Number(e.target.value) }))}
                    className="w-full border rounded-lg px-3 py-2 text-sm outline-none focus:border-brand-500" min={0} />
                </div>
                <div>
