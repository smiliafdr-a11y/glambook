...
export default function ListeAttentePage() {
  ...
  return (
    <div className="p-6 max-w-3xl">
      ...
      {/* Explication */}
      <div className="bg-pink-50 border border-brand-100 rounded-xl p-4 mb-6 text-sm text-brand-700">
        ...
        <div className="space-y-3">
          {liste.map((l, i) => (
            <div key={l.id} className="bg-white rounded-xl border border-gray-100 p-4 flex items-center gap-4">
              <div className="w-8 h-8 rounded-full bg-pink-500 text-white text-sm font-bold flex items-center justify-center flex-shrink-0">
                {i + 1}
              </div>
