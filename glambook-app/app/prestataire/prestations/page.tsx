  ...
  return (
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <button onClick={openAdd} className="bg-pink-500 text-white text-sm px-4 py-2 rounded-lg font-medium hover:bg-brand-600">
          + Nouvelle prestation
        </button>
      </div>
      ...
      {prestations.length === 0 ? (
        <div className="text-center py-20 bg-white rounded-2xl border border-gray-100">
          ...
          <button onClick={openAdd} className="bg-pink-500 text-white text-sm px-5 py-2.5 rounded-lg font-medium hover:bg-brand-600">
