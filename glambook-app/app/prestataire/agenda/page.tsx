    ...
    <div className="flex h-full">
      ...
      <div className="flex-1 p-6 overflow-y-auto">
        ...
        <div className="flex items-center justify-between mb-5">
          ...
          <button onClick={() => setShowModal(true)} className="bg-brand-500 text-white text-sm px-4 py-2 rounded-lg font-medium hover:bg-brand-600 transition-colors">
            + Nouveau RDV
          </button>
        </div>
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between mb-1">
                  <span className={`text-xs font-semibold ${isToday ? 'bg-brand-500 text-white w-5 h-5 rounded-full flex items-center justify-center' : isSunday ? 'text-red-400' : 'text-gray-600'}`}>
                    {d}
                  </span>
                  {dayRdvs.length > 0 && (
      ...
      <div className="w-72 border-l border-gray-100 bg-white flex flex-col overflow-y-auto">
        ...
        <div className="p-4 border-t border-gray-100">
          <button onClick={() => setShowModal(true)} className="w-full bg-brand-500 text-white text-sm py-2.5 rounded-lg font-medium hover:bg-brand-600 transition-colors">
            + Ajouter un RDV
          </button>
        </div>
      </div>
